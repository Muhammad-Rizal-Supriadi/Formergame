...
public class Level5 extends World
{
   ...
   public GreenfootSound bg1 = new GreenfootSound("level1.mp3");
    ...
    private void prepare()
    {
        ...
        addObject(coin15,2095,498);
        Coin coin16 = new Coin();
        addObject(coin16,2162,497);
        Coin coin17 = new Coin();
        addObject(coin17,2229,502);
        coin17.setLocation(2228,497);
        MainLagi mainLagi = new MainLagi();
        addObject(mainLagi,54,352);
        removeObject(ranjau);
        removeObject(ranjau2);
        removeObject(ranjau3);
        Ranjau_4 ranjau_4 = new Ranjau_4();
        addObject(ranjau_4,621,575);
        ranjau_4.setLocation(603,594);
        Enemy4 enemy4 = new Enemy4();
        addObject(enemy4,508,202);
        Enemy4 enemy42 = new Enemy4();
        addObject(enemy42,1006,412);
        awan8.setLocation(1361,164);
        Enemy4 enemy43 = new Enemy4();
        addObject(enemy43,1361,164);
        Enemy4 enemy44 = new Enemy4();
        addObject(enemy44,1537,372);
        awan5.setLocation(2046,188);
        Enemy4 enemy45 = new Enemy4();
        addObject(enemy45,2046,188);
        awan7.setLocation(1704,164);
        Enemy4 enemy46 = new Enemy4();
        addObject(enemy46,1704,164);
        Enemy4 enemy47 = new Enemy4();
        addObject(enemy47,2257,384);
        Enemy4 enemy48 = new Enemy4();
        addObject(enemy48,2480,186);
        ground_Atas4.setLocation(2410,343);
        secretDoor.setLocation(2461,90);
        removeObject(secretDoor);
        Pintu4 pintu4 = new Pintu4();
        addObject(pintu4,2430,262);
        pintu4.setLocation(2443,279);
        removeObject(pintu4);
        Finish finish = new Finish();
        addObject(finish,2429,272);
        Finish finish2 = new Finish();
        addObject(finish2,1134,192);
        Ranjau_4 ranjau_42 = new Ranjau_4();
        addObject(ranjau_42,1972,579);
        ranjau_42.setLocation(1969,587);
        ranjau_42.setLocation(1258,608);
        ranjau_42.setLocation(1916,595);
        finish2.setLocation(1131,198);
        removeObject(finish2);
        enemy4.setLocation(828,195);
        enemy4.setLocation(744,150);
        awan3.setLocation(753,88);
        awan8.setLocation(1395,106);
        awan7.setLocation(1808,142);
        awan7.setLocation(1808,122);
        awan7.setLocation(1837,121);
        awan5.setLocation(2180,123);
        awan4.setLocation(2201,118);
        mainLagi.setLocation(39,347);
    }
